...
using AbpPractice.Web.Models.Account;
using AbpPractice.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : AbpPracticeControllerBase
{
