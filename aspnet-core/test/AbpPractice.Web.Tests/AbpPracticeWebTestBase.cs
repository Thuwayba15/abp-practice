...
using AbpPractice.Models.TokenAuth;
...
public abstract class AbpPracticeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static AbpPracticeWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(AbpPracticeWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<AbpPracticeDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<AbpPracticeDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<AbpPracticeDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<AbpPracticeDbContext, Task<T>> func)
    {
        T result;
